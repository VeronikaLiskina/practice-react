...
var arrOne = ['Ваня', 'Иштван', 'Оля']; //Начиная с первой позиции(Иштван), удаляем один элемент 

arrOne.splice(1, 1);
alert(arrOne); //Удаляем элемент и возвращаем его в переменную

var arrTwo = ['Ваня', 'Иштван', 'Оля'];
var removed = arrTwo.splice(1, 1);
alert(removed); //Заменяем элемент

var arrThree = ['Ваня', 'Иштван', 'Оля']; //Начиная с нулевой позиции (Ваня), заменяем один элемент

arrThree.splice(0, 1, 'Коля');
alert(arrThree); //Добавляем элементы

var arrFour = ['Ваня', 'Иштван', 'Оля']; //начиная с первой позиции добавляем два элемента

arrFour.splice(1, 0, 'Коля', 'Маша');
alert(arrFour);
var arrFive = ['Ваня', 'Иштван', 'Оля']; //начиная с последней позиции удаляем один элемент

arrFive.splice(-1, 1);
alert(arrFive); // МЕТОДЫ МАССИВОВ
